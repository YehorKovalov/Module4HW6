    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ArtistId = table.Column<int>(type: "int", nullable: false),
                    SondId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistSong", x => new { x.ArtistId, x.SondId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ArtistSong_Song_SondId",
                        column: x => x.SondId,
                        principalTable: "Song",
